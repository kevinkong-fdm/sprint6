...
class AccountCreateListContractTest {
    ...
    void shouldCreateAccount() throws Exception {
        ...
        when(createAccountService.create(any(), any())).thenReturn(sampleAccount("CHECKING", "Primary"));
    ...
    void shouldListAccounts() throws Exception {
        ...
        when(listAccountsService.list(any(), any(), any(Integer.class), any(Integer.class)))
                .thenReturn(new AccountListResponse(List.of(sampleAccount("CHECKING", "Primary")), 1, 20, 1));
        ...
        mockMvc.perform(get("/accounts")
                ...
                .andExpect(jsonPath("$.items[0].accountId").value("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"));
    }

    private AccountResponse sampleAccount(String type, String nickname) {
