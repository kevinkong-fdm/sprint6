...
export function LoginPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl animate-fade-up space-y-4">
      <section className="rounded-3xl border border-white/15 bg-slate-900/60 p-5 shadow-soft backdrop-blur-xl sm:p-7">
        <div className="mb-5">
      ...
      <footer className="rounded-2xl border border-white/10 bg-slate-900/35 px-4 py-3 text-xs leading-5 text-slate-300/90 backdrop-blur-xl">
        <p>Protected banking for account, customer, and payment operations.</p>
        <p className="text-slate-400">Need help signing in? Use password reset or contact support.</p>
      </footer>
    </div>
  );
}
